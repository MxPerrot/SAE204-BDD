...
select cod_aff_form, commune_nom, effectif_admis_neo_bac_selon_mention, libelle_mention from _effectif_selon_mention natural join _formation; 

create or replace view sae204v5 as 
  select commune_nom, libelle_mention, sum(effectif_admis_neo_bac_selon_mention)
  from _effectif_selon_mention
  natural join _formation
  group by libelle_mention, commune_nom;
